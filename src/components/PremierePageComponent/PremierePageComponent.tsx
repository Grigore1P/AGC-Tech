        ...
        <div className="curs ml-10">
          ...
          <div className="about mt-[-20px]">
            ...
            <p className="text-[#C7C8CC] mt-4">
              Adobe Premiere Pro este unul dintre cele mai populare și puternice
              programe <br /> de editare video disponibile pe piață. Acesta
              oferă un set complet de instrumente <br />
              și funcții pentru editarea video, inclusiv montaj non-liniar,
              ajustarea culorilor, efecte vizuale, <br /> titluri și multe
              altele.
            </p>
          </div>
          <button
