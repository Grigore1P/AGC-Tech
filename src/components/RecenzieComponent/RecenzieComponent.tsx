...
const RecenzieComponent = () => {
    ...
    return (
        <div className='text-black p-10 relative w-screen bg-gradient-to-r from-black to-[#57033F] via-black animate-gradient-x min-h-screen flex items-center justify-center'>
            ...
            <div className='recenzie bg-[#222831] p-8 rounded-2xl shadow-md w-full max-w-md z-10'>
                <h1 className='text-2xl flex justify-center text-white font-bold mb-4'>Leave Your Feedback</h1>
                <form onSubmit={handleSubmit} className='space-y-6'>
                    <div>
                        <label className='block text-[#686D76] text-sm font-bold mb-2' htmlFor='name'>Name</label>
                        <input
                            type='text'
                            id='name'
                            value={name}
                    ...
                    <div>
                        <label className='block text-[#686D76] text-sm font-bold mb-2' htmlFor='feedback'>Feedback</label>
                        <textarea
                            id='feedback'
                            value={feedback}
                            onChange={(e) => setFeedback(e.target.value)}
                            className='w-full h-[200px] p-2 border bg-[#373A40] border-[#57033F] text-white rounded mb-4 mt-2 focus:border-[#ffc0eb]'
                            required
                        ></textarea>
                    </div>
                    <div>
