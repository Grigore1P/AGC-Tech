        ...
        <div className="curs ml-10">
          ...
          <div className="about mt-[-20px]">
            ...
            <p className="text-[#C7C8CC] mt-4">
              JavaScript este un limbaj de programare fundamental pentru
              dezvoltarea paginilor web interactive.
              <br />
              Împreună cu HTML și CSS, JavaScript completează triada esențială a
              dezvoltării web front-end. <br />
              Acesta este folosit pentru a crea funcționalități interactive pe
              paginile web, precum animații, efecte vizuale, validarea
              formularelor și multe altele.
            </p>
          </div>
          <button
