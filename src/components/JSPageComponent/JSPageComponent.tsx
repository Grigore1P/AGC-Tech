    ...
    return (
        <div className="main bg-black h-[1100px] relative w-screen">
            ...
            <div className="categorii ml-40">
                ...
                /
                <button className="frontend text-white" onClick={() => handleCategoryClick("front-end")}>Front-End</button>
            </div>
            ...
            <div className="w-[900px] h-[400px] bg-gradient-to-l from-[#00052D] to-[#57003F] ml-40 rounded-3xl">
                ...
                <div className="curs ml-10">
                    <h4 className="text-white font-bold text-xl">Curs JavaScript</h4>
                    <img className="w-[55px] h-[55px] ml-[190px] mt-[-35px] rounded-full" src={javascript1} alt="" />
                    <div className="about mt-[-20px]">
                        <h3 className="text-[#891652] font-bold">Coming soon</h3>
                        <p className="text-[#C7C8CC] mt-4">JavaScript este un limbaj de programare fundamental pentru
                            dezvoltarea paginilor web interactive.<br />
                            Împreună cu HTML și CSS, JavaScript completează triada
                            esențială a dezvoltării web front-end. <br />
                            Acesta este folosit pentru a crea funcționalități interactive
                            pe paginile web, precum animații, efecte vizuale, validarea formularelor și multe altele.
                        </p>
                    </div>
                    <button
...
export default JSPageComponent;
