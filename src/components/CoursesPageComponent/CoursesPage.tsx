...
const CoursesPage = () => {
  ...
  return (
    <div className="main bg-black h-[1100px] relative w-screen ">
      <br />
      <br />
      <h1 className="text-white text-3xl font-bold ml-[600px]">
      ...
      <div className="categorii ml-40 mt-10">
        ...
        /<span className="text-gray-400">/</span>/
        <button
          className={`text-gray-400 ${selectedCategory === 'back-end' ? 'text-white' : ''}`}
        ...
        /<span className="text-gray-400">/</span>/
        <button
          className={`text-gray-400 ${selectedCategory === 'video-editing' ? 'text-white' : ''}`}
