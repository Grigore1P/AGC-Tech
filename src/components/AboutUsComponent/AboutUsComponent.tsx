    ...
    return (
        <div className="main bg-black h-fit relative w-screen">
            ...
            <p className="text-gray-400 font-sans text-s ml-40 mt-10">
                Oferim cursuri de înaltă calitate pentru a pregăti studenții pentru provocările tehnologice ale viitorului.
                Ne dedicăm să oferim tot ce e mai bun în cunoștințe și resurse,<br />
                de aceea locurile pentru mentoratul nostru sunt limitate. Încurajăm excelența și inovația într-un mediu prietenos și stimulant,
                în care fiecare student poate să-și dezvolte potențialul la maxim. <br />
            </p>

            <h2 className="cui text-white font-bold font-sans text-2xl ml-[320px] mt-20">Cui se adresează cursurile AGC?</h2>
            <ol className="text-gray-400 font-sans text-s ml-[320px] mt-4 list-disc text-white" >
                <li>Elevilor sau studenților, angajaților din orice domeniu cu 0 experiență în domeniul IT</li>
                <li>Copiilor pasionați de programare ce doresc să învețe arta dezvoltărilor aplicațiilor WEB</li>
                <li>Oamenilor care au început deja să învețe programare, dar nu se descurcă să creeze singuri <br />
                    aplicații sau să obțină un job în domeniu;</li>
                <li>Persoanelor cu experiență deja în programare și care vor să-și dezvolte abilitățile.</li>
            </ol>
                <img src={codingmeet} alt="" className="w-[670px] h-[445px] rounded-3xl ml-[60px] mt-36" />
                <img src={programmer} alt="" className="w-[670px] h-[500px] rounded-3xl ml-[780px] mt-[-500px]" />
