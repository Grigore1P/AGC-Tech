        ...
        <div className="curs ml-10">
          ...
          <div className="about mt-[-20px]">
            ...
            <p className="text-[#C7C8CC] mt-4">
              MySQL este un sistem de gestionare a bazelor de date relaționale
              (RDBMS) extrem de popular, <br />
              utilizat în mod obișnuit în aplicațiile web pentru stocarea și
              gestionarea datelor. <br />
              MySQL oferă o modalitate eficientă și fiabilă de a organiza și
              accesa datele, fiind ideal pentru aplicații care necesită o
              gestionare complexă a datelor, cum ar fi magazinele online,
              sistemele de gestionare a conținutului și multe altele.
            </p>
          </div>
          <button
