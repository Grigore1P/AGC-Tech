    ...
    <div className="Header h-16 w-full bg-gradient-to-r from-[#00052D] to-[#57003F] text-white text-xl">
      <ul className="flex items-center justify-center space-x-20 relative">
        ...
        <li className="group relative inline-block">
          <Link
            to="/courses"
            className="p-2 ml-10 mt-2 relative z-10 text-white transition duration-300 ease-in-out transform rounded-lg group-hover:animate-shake group-hover:scale-110 group-hover:bg-gradient-to-r group-hover:from-[#EAD5E6] group-hover:via-[#F2BEFC] group-hover:to-[#F3E0EC] group-hover:bg-clip-text group-hover:text-transparent group-hover:shadow-[0_0_20px_10px_#EE85B5]"
          >
            COURSES
          </Link>
        </li>
        <li className="group relative inline-block">
          <button className="p-2 ml-10 mt-1 relative z-10 text-white transition duration-300 ease-in-out transform rounded-lg group-hover:animate-shake group-hover:scale-110 group-hover:bg-gradient-to-r group-hover:from-[#EAD5E6] group-hover:via-[#F2BEFC] group-hover:to-[#F3E0EC] group-hover:bg-clip-text group-hover:text-transparent group-hover:shadow-[0_0_20px_10px_#EE85B5]">
            LOGO
          </button>
        </li>
        <li className="group relative inline-block">
